  ...
  const cards = [
    {
      ...
      bgColor: 'bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900/40 dark:to-green-900/40',
      iconBg: 'bg-gradient-to-br from-emerald-100 to-emerald-200 dark:from-emerald-800/60 dark:to-emerald-700/60',
      icon: CheckCircle,
    ...
    },
    {
      ...
      bgColor: 'bg-gradient-to-br from-rose-50 to-red-50 dark:from-rose-900/40 dark:to-red-900/40',
      iconBg: 'bg-gradient-to-br from-rose-100 to-rose-200 dark:from-rose-800/60 dark:to-rose-700/60',
      icon: XCircle,
    ...
    },
    {
      ...
      bgColor: 'bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-900/40 dark:to-yellow-900/40',
      iconBg: 'bg-gradient-to-br from-amber-100 to-amber-200 dark:from-amber-800/60 dark:to-amber-700/60',
      icon: AlertTriangle,
